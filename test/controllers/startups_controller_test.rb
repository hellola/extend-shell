...
class StartupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post startups_url, params: { startup: { command: @startup.command, location_id: @startup.location_id, name: @startup.name, operating_system_id: @startup.operating_system_id } }
    end
  ...
  test "should update startup" do
    patch startup_url(@startup), params: { startup: { command: @startup.command, location_id: @startup.location_id, name: @startup.name, operating_system_id: @startup.operating_system_id } }
